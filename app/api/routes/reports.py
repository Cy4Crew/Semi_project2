...
def report_view(report_id: str):
    ...
    <section class="grid"><div class="card"><h2 style="margin-top:0;">Evidence reasons</h2><ul class="reasons">{evidence_html}</ul></div><div class="card"><h2 style="margin-top:0;">Sample hashes</h2><div class="hashes">{hash_html}</div></div></section>
    ...
    <section class="card"><h2 style="margin-top:0;">Analyzed Files</h2><table><thead><tr><th>File</th><th>Score</th><th>Severity</th><th>Evidence</th><th>YARA</th><th>Tags</th></tr></thead><tbody>{files_html}</tbody></table></section>
